# mail-egress Specification

## Purpose

Send iCalendar objects as iTIP email messages over SMTP, deriving recipients and content-type metadata while honouring caller-supplied overrides.
