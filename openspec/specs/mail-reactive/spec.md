# mail-reactive Specification

## Purpose

Provide a reactive publisher that emits calendar objects to subscribers as matching messages arrive in monitored mail folders, maintaining a live connection for event delivery.
