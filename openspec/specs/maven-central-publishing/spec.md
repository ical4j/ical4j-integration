# maven-central-publishing Specification

## Purpose

Publish the project's release and snapshot artifacts to Maven Central via the Sonatype Central Portal, with GPG-signed artifacts, version derived from release tags, and credentials supplied through CI secrets — independently of GitHub Release creation.
